...
// Code 5a - 5f here:
 ...
 if (fuelLevel > 20000 && engineTemperature <= 2500) {
    console.log("Full tank. Enginges good");
...
if (commandOverride === true && fuelLevel < 1000 || engineTemperature > 3500) {
    console.log(`Command Override in place: Shuttle will launch`)
} 
